...
export const marcasApi = {
  async getAll(params?: GetCatalogParams): Promise<ApiResponse<CatalogResponse<Marca>>> {
  ...
  async create(data: { name: string; estado?: boolean }): Promise<ApiResponse<Marca>> {
  ...
  async update(id: number, data: { name: string; estado?: boolean }): Promise<ApiResponse<Marca>> {
    return apiRequest<Marca>(`/marcas/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
...
export const categoriasApi = {
  async getAll(params?: GetCatalogParams): Promise<ApiResponse<CatalogResponse<Categoria>>> {
    const queryString = params
      ? '?' + new URLSearchParams(
          Object.entries(params).reduce((acc, [key, value]) => {
            if (value !== undefined) {
  ...
  async create(data: { name: string; estado?: boolean }): Promise<ApiResponse<Categoria>> {
  ...
  async update(id: number, data: { name: string; estado?: boolean }): Promise<ApiResponse<Categoria>> {
    return apiRequest<Categoria>(`/categorias/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
...
export const ubicacionesApi = {
  async getAll(params?: GetCatalogParams): Promise<ApiResponse<CatalogResponse<Ubicacion>>> {
    const queryString = params
      ? '?' + new URLSearchParams(
          Object.entries(params).reduce((acc, [key, value]) => {
            if (value !== undefined) {
  ...
  async create(data: { name: string; almacen_id: number; estado?: boolean }): Promise<ApiResponse<Ubicacion>> {
  ...
  async update(id: number, data: { name: string; almacen_id: number; estado?: boolean }): Promise<ApiResponse<Ubicacion>> {
    return apiRequest<Ubicacion>(`/ubicaciones/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
   ...
   */
  async importMany(ubicaciones: { name: string; almacen_id: number }[]): Promise<ApiResponse<Ubicacion[]>> {
...
export const unidadesMedidaApi = {
  async getAll(params?: GetCatalogParams): Promise<ApiResponse<CatalogResponse<UnidadMedida>>> {
    const queryString = params
      ? '?' + new URLSearchParams(
          Object.entries(params).reduce((acc, [key, value]) => {
            if (value !== undefined) {
      ...
      : '';
    return apiRequest<CatalogResponse<UnidadMedida>>(`/unidades-medida${queryString}`);
  },
  ...
  async create(data: { name: string; estado?: boolean }): Promise<ApiResponse<UnidadMedida>> {
  ...
  async update(id: number, data: { name: string; estado?: boolean }): Promise<ApiResponse<UnidadMedida>> {
    return apiRequest<UnidadMedida>(`/unidades-medida/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
...
export const unidadesDerivadas = {
  async getAll(params?: GetCatalogParams): Promise<ApiResponse<CatalogResponse<UnidadDerivada>>> {
    const queryString = params
      ? '?' + new URLSearchParams(
          Object.entries(params).reduce((acc, [key, value]) => {
            if (value !== undefined) {
      ...
      : '';
    return apiRequest<CatalogResponse<UnidadDerivada>>(`/unidades-derivadas${queryString}`);
  },
  ...
  async create(data: { name: string; estado?: boolean }): Promise<ApiResponse<UnidadDerivada>> {
  ...
  async update(id: number, data: { name: string; estado?: boolean }): Promise<ApiResponse<UnidadDerivada>> {
    return apiRequest<UnidadDerivada>(`/unidades-derivadas/${id}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    });
