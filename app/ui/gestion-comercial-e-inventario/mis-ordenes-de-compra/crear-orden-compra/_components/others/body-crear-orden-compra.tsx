...
import SidebarSolicitudes, { type ProductoSidebarSelection } from '../sidebar-solicitudes'
import HeaderCrearOrdenCompra from './header'
...
export default function BodyCrearOrdenCompra() {
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col gap-2 xl:gap-3 min-w-0 min-h-0 overflow-hidden">
            ...
            <div className='flex flex-col gap-0'>
              <div className='flex flex-wrap gap-x-3 gap-y-0 sm:gap-x-4 lg:gap-x-6 lg:-mb-6'>
