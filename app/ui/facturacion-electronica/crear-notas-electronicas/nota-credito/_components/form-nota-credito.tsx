...
export default function FormNotaCredito({ form, loading }: FormNotaCreditoProps) {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <SelectBase
            ...
            prefix={<FaFileInvoice className="text-blue-600" />}
            options={[
      ...
      <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
        ...
        <p className="text-xs text-gray-600 mt-1">
          Escanee o digite el motivo de la nota de crédito en letras
        </p>
      </div>
      ...
      {/* Tabla de Productos */}
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <TableProductosNotaCredito form={form} />
      </div>
