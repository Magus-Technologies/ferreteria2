...
export default function CardsInfoNotaCredito({ form, loading }: CardsInfoNotaCreditoProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
        <h4 className="font-semibold text-blue-800 mb-2 text-sm">Valor Refer.</h4>
