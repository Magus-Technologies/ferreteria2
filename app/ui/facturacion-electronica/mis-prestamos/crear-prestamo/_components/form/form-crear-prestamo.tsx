...
export default function FormCrearPrestamo({
  ...
  const { user } = useAuth();
  const tipo_entidad = useStoreProductoAgregadoPrestamo((state) => state.tipo_entidad);
  const tipo_operacion = useStoreProductoAgregadoPrestamo((state) => state.tipo_operacion);
  const setTipoEntidad = useStoreProductoAgregadoPrestamo((state) => state.setTipoEntidad);
  const setTipoOperacion = useStoreProductoAgregadoPrestamo((state) => state.setTipoOperacion);
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-4">
        ...
        <LabelBase label="Operación:" classNames={{ labelParent: "mb-6" }}>
          <Form.Item name="tipo_operacion" initialValue={TipoOperacion.PRESTAR} rules={[{ required: true }]}>
            <Select
              className="!w-[170px]"
        ...
        <LabelBase label="Tipo:" classNames={{ labelParent: "mb-6" }}>
          <Form.Item name="tipo_entidad" initialValue={TipoEntidad.CLIENTE} rules={[{ required: true }]}>
            <Select
              className="!w-[150px]"
        ...
        <LabelBase label="Moneda:" classNames={{ labelParent: "mb-6" }}>
          <Form.Item name="tipo_moneda" initialValue={TipoMoneda.SOLES} rules={[{ required: true }]}>
            <Select
              className="!w-[120px]"
              options={[
      ...
      <div className="flex gap-4">
        ...
        <LabelBase label="Observaciones:" orientation="column" className="flex-1">
          <TextareaBase
