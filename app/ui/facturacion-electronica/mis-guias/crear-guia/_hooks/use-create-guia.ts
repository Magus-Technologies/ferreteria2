...
export default function useCreateGuia(form: FormInstance<FormCreateGuia>) {
  ...
  const handleSubmit = async (values: FormCreateGuia) => {
    ...
    const data: CreateGuiaRemisionRequest = {
      ...
      transportista_ruc: values.transportista_ruc || undefined,
      transportista_razon_social: values.transportista_razon_social || undefined,
      transportista_nro_mtc: values.transportista_nro_mtc || undefined,
