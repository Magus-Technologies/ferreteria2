...
import TableDetallesNotaDebito from "~/app/ui/facturacion-electronica/mis-facturas/_components/tables/table-detalles-nota-debito";

interface ModalCrearNotaDebitoProps {
  open: boolean;
...
export default function ModalCrearNotaDebito({
  ...
  const handleFinish = async (values: FormValues) => {
    ...
    try {
      ...
      const response = await facturacionElectronicaApi.crearNotaDebito(data);
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <DatePickerBase
            ...
            prefix={<FaCalendar className="text-orange-600" />}
          />
        </div>
