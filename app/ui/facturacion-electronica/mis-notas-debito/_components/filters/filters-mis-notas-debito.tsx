...
export default function FiltersMisNotasDebito() {
  ...
  return (
    ...
    >
      ...
      >
        <ConfigurableElement
          componentId='mis-notas-debito.boton-crear'
          label='Botón Crear Nota de Débito'
        >
          <ButtonBase
            color="success"
            size="md"
      ...
      <div className="mt-4 grid grid-cols-12 gap-x-3 gap-y-2.5">
        ...
        <div className="col-span-1 flex items-center">
          <ConfigurableElement componentId='mis-notas-debito.boton-buscar' label='Botón Buscar'><ButtonBase color="info" size="md" type="submit" className="flex items-center gap-2 w-full justify-center"><FaSearch />Buscar</ButtonBase></ConfigurableElement>
        </div>
      </div>
    </FormBase>
  );
