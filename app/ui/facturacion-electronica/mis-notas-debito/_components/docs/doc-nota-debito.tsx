...
export interface ProductoNotaDebitoPDF {
    codigo: string
    descripcion: string
    cantidad: number
    unidad: string
...
export interface NotaDebitoDataPDF {
    id: string
    numero: string
    fecha: string
    motivo: string
    ...
    productos: ProductoNotaDebitoPDF[]
    subtotal: number
    igv: number
    total: number
...
export default function DocNotaDebito({
    data,
    nro_doc,
    empresa,
    show_logo_html = false,
}: {
    data: NotaDebitoDataPDF | undefined
    nro_doc: string
    ...
    const colDefs: ColDef<ProductoNotaDebitoPDF>[] = [
        {
            headerName: 'Código',
            field: 'codigo',
            width: 50,
    ...
    return (
        <DocGeneral
            ...
            totalConLetras
        >
            {/* Información del Cliente y Nota de Débito */}
                ...
                <View style={styles_docs.sectionInformacionGeneral}>
                    <View style={styles_docs.sectionInformacionGeneralColumn}>
                        ...
                        <View style={styles_docs.subSectionInformacionGeneral}>
                            ...
                            <Text style={styles_docs.textValueSubSectionInformacionGeneral}>
                                {data.moneda === 'USD' ? 'DOLARES AMERICANOS (USD)' : 'SOLES (PEN)'}
                            </Text>
                        </View>
                    ...
                    <View style={styles_docs.sectionInformacionGeneralColumn}>
                        ...
                        <View style={styles_docs.subSectionInformacionGeneral}>
                            ...
                            <Text style={styles_docs.textValueSubSectionInformacionGeneral}>
                                {getTipoComprobanteLabel(data.comprobante_afectado?.tipo || 'COMPROBANTE')} {data.comprobante_afectado?.numero || 'N/A'}
                            </Text>
                        </View>
                        ...
                        <View style={styles_docs.subSectionInformacionGeneral}>
                            ...
                            <Text style={styles_docs.textValueSubSectionInformacionGeneral}>
                                {data.motivo_codigo ? `${data.motivo_codigo} - ` : ''}{data.motivo || 'Sin motivo especificado'}
                            </Text>
                        </View>
                    </View>
                </View>
...
function getTipoComprobanteLabel(tipo: string): string {
