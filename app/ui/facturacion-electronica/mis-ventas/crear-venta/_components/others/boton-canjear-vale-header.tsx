...
export default function BotonCanjearValeHeader() {
  ...
  const codigoActual = Form.useWatch('codigo_vale', storeForm ?? undefined) as string | undefined
        ...
        onAplicar={(codigo, info) => {
          ...
          if (info?.vale_compra && !valesActuales.some(v => v.id === info.vale_compra.id)) {
            ...
            const valeParaStore: ValeCompra = {
              ...
              descuento_alcance: ((v as any).descuento_alcance ?? null) as any,
              descuento_producto_ids: (v as any).descuento_producto_ids ?? null,
              ...
              dias_validez_vale: (v as any).dias_validez_vale ?? null,
