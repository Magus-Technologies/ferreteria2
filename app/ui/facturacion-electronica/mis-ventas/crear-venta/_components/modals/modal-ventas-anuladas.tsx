...
export default function ModalVentasAnuladas({
  ...
  const [ventaSeleccionada, setVentaSeleccionada] = useState<getVentaResponseProps | null>(null)
      ...
      <div className='flex flex-col gap-4' style={{ height: 500 }}>
        <div style={{ height: 250 }}>
          <TableWithTitle<getVentaResponseProps>
            id='ventas-anuladas'
            title='VENTAS ANULADAS (doble click para recuperar)'
            loading={isLoading}
            columnDefs={columns}
            rowData={data || []}
