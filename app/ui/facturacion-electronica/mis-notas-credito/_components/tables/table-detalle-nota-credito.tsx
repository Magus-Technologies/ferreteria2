...
import { useStoreNotaCreditoSeleccionada } from './table-mis-notas-credito'
...
export default function TableDetalleNotaCredito() {
  const nota = useStoreNotaCreditoSeleccionada((state) => state.nota)

  // Los items de una nota de crédito son los del comprobante afectado
