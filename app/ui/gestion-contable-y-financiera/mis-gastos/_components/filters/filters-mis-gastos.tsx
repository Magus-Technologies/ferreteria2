...
/**
 * Roles que ven TODOS los gastos: para ellos el filtro "Vendedor" arranca
    ...
    >
      ...
      <div className='flex items-center gap-2 w-full mt-4 overflow-x-auto'>
        ...
        <div className='hidden lg:flex items-end gap-3 flex-nowrap min-w-max w-full'>
          ...
          <ConfigurableElement componentId='gestion-contable.mis-gastos.filtro-vendedor' label='Filtro Vendedor'>
