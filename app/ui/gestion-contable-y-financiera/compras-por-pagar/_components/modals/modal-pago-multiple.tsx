...
export default function ModalPagoMultiple({ open, setOpen }: ModalPagoMultipleProps) {
  ...
  // Sin filtro por comprobante a propósito: `tipos_comprobante` de las sub-cajas
  // define qué RECIBE cada caja al vender, no con qué se puede pagar a un
  // proveedor. El backend de pagos de compra tampoco lo mira — resuelve la
  // sub-caja solo por el método de pago.
