    ...
    >
      ...
      <div className='flex items-center gap-2 w-full mt-4 overflow-x-auto'>
        ...
        <div className='hidden lg:flex items-end gap-3 flex-nowrap min-w-max w-full'>
          ...
          <ConfigurableElement componentId='gestion-contable.mis-Ingresos.filtro-motivo' label='Filtro Motivo de Ingreso'>
            <LabelBase label='Motivo de Ingreso:'>
              <Form.Item name='motivoIngreso' className='!mb-0'>
                <Input
          ...
          <ConfigurableElement componentId='gestion-contable.mis-Ingresos.filtro-sucursal' label='Filtro Sucursal'>
          ...
          <ConfigurableElement componentId='gestion-contable.mis-Ingresos.boton-buscar' label='Botón Buscar'>
            <ButtonBase
              type='submit'
              color='info'
              size='sm'
