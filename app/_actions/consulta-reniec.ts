...
async function consultaReniecWA({ search }: { search: string }) {
  if (search.length !== 8 && search.length !== 11)
    throw new Error('El número de dni debe tener 8 u 11 caracteres')
...
export const consultaReniec = withAuth(consultaReniecWA)
